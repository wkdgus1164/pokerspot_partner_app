...
abstract class $SigninModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String password, bool isPwVisible});
}
    ...
    return _then(_value.copyWith(
      ...
      password: null == password
          ...
          : password // ignore: cast_nullable_to_non_nullable
              as String,
      isPwVisible: null == isPwVisible
          ? _value.isPwVisible
          : isPwVisible // ignore: cast_nullable_to_non_nullable
              as bool,
    ) as $Val);
  }
}
...
class _$SigninModelImpl implements _SigninModel {
  _$SigninModelImpl(
      {required this.id, required this.password, required this.isPwVisible});
  ...
  @override
  String toString() {
    return 'SigninModel(id: $id, password: $password, isPwVisible: $isPwVisible)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.isPwVisible, isPwVisible) ||
...
abstract class _SigninModel implements SigninModel {
  factory _SigninModel(
      ...
      required final bool isPwVisible}) = _$SigninModelImpl;
