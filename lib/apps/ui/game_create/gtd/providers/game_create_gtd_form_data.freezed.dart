...
part of 'game_create_gtd_form_data.dart';
...
/// @nodoc
mixin _$GameCreateGTDFormModel {
...
/// @nodoc
abstract class $GameCreateGTDFormModelCopyWith<$Res> {
  factory $GameCreateGTDFormModelCopyWith(GameCreateGTDFormModel value,
          $Res Function(GameCreateGTDFormModel) then) =
      _$GameCreateGTDFormModelCopyWithImpl<$Res, GameCreateGTDFormModel>;
  @useResult
  $Res call(
      {String gameName,
      int buyIn,
...
/// @nodoc
class _$GameCreateGTDFormModelCopyWithImpl<$Res,
        $Val extends GameCreateGTDFormModel>
    implements $GameCreateGTDFormModelCopyWith<$Res> {
  _$GameCreateGTDFormModelCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$GameCreateGTDFormModelImplCopyWith<$Res>
    implements $GameCreateGTDFormModelCopyWith<$Res> {
  factory _$$GameCreateGTDFormModelImplCopyWith(
          _$GameCreateGTDFormModelImpl value,
          $Res Function(_$GameCreateGTDFormModelImpl) then) =
      __$$GameCreateGTDFormModelImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String gameName,
...
/// @nodoc
class __$$GameCreateGTDFormModelImplCopyWithImpl<$Res>
    extends _$GameCreateGTDFormModelCopyWithImpl<$Res,
        _$GameCreateGTDFormModelImpl>
    implements _$$GameCreateGTDFormModelImplCopyWith<$Res> {
  __$$GameCreateGTDFormModelImplCopyWithImpl(
      _$GameCreateGTDFormModelImpl _value,
  ...
  $Res call({
    ...
    return _then(_$GameCreateGTDFormModelImpl(
      gameName: null == gameName
          ? _value.gameName
          : gameName // ignore: cast_nullable_to_non_nullable
              as String,
...
class _$GameCreateGTDFormModelImpl extends _GameCreateGTDFormModel {
  _$GameCreateGTDFormModelImpl(
  ...
  @override
  String toString() {
    return 'GameCreateGTDFormModel(gameName: $gameName, buyIn: $buyIn, minEntry: $minEntry, maxEntry: $maxEntry, prize: $prize, duration: $duration, minReward: $minReward, firstGame: $firstGame, everyDay: $everyDay, isValid: $isValid)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$GameCreateGTDFormModelImpl &&
  ...
  _$$GameCreateGTDFormModelImplCopyWith<_$GameCreateGTDFormModelImpl>
      get copyWith => __$$GameCreateGTDFormModelImplCopyWithImpl<
          _$GameCreateGTDFormModelImpl>(this, _$identity);
}

abstract class _GameCreateGTDFormModel extends GameCreateGTDFormModel {
  factory _GameCreateGTDFormModel(
      ...
      required final bool isValid}) = _$GameCreateGTDFormModelImpl;
  _GameCreateGTDFormModel._() : super._();
